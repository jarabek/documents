...
*A living document capturing my approach to building software products and leading high-performance engineering teams. These principles are a mixture of lessons learned from years of practice, and insights of people smarter than me, most notably my mentors [Sandy Anuras](https://www.linkedin.com/in/sandyanuras/) and [Andrew Coldham](https://www.linkedin.com/in/andrewcoldham/). Elsewhere, I've tried to give credit where it's due.*
